...
class Stream implements Stream_Interface
{
    ...
    public function __construct($stream, array $options = [])
    {
        ...
        $this->custom_metadata = $options['metadata'] ?? [];
        $this->stream = $stream;
        $meta = stream_get_meta_data($this->stream);
        $this->seekable = $meta['seekable'];
        $this->readable = (bool) preg_match(self::READABLE_MODES, $meta['mode']);
        $this->writable = (bool) preg_match(self::WRITABLE_MODES, $meta['mode']);
        $this->uri = $this->get_metadata('uri');
    }
    /**
    ...
    public function get_contents(): string
    {
        ...
        return Utils::try_get_contents($this->stream);
    }
    ...
    public function get_metadata($key = null)
    {
        ...
        if (!$key) {
            return $this->custom_metadata + stream_get_meta_data($this->stream);
        }
        if (isset($this->custom_metadata[$key])) {
            return $this->custom_metadata[$key];
        }
        $meta = stream_get_meta_data($this->stream);
